...
export interface DisciplinesTranslation {
	/** @primaryKey */
	id: number;
	disciplines_id?: Discipline | string | null;
...
export interface EventsDiscipline {
	/** @primaryKey */
	id: number;
...
export interface FormField {
	...
	type?: 'text' | 'textarea' | 'checkbox' | 'checkbox_group' | 'radio' | 'file' | 'select' | 'hidden' | 'discipline' | null;
	...
	date_updated?: string | null;
	user_updated?: DirectusUser | string | null;
	disciplines?: FormFieldsDiscipline[] | string[];
}

export interface FormFieldsDiscipline {
	/** @primaryKey */
	id: number;
...
export interface Globals {
	...
	date_updated?: string | null;
	user_updated?: DirectusUser | string | null;
	logo_footer?: DirectusFile | string | null;
	logo_footer_dark_mode?: DirectusFile | string | null;
}
...
export interface Member {
	...
	city?: string | null;
	portrait?: DirectusFile | string | null;
	postbox?: string | null;
	title?: string | null;
	police_station?: string | null;
	discipline?: 'json' | null;
	disciplines?: MembersDiscipline[] | string[];
}

export interface MembersDiscipline {
	/** @primaryKey */
	id: number;
	members_id?: Member | string | null;
	disciplines_id?: Discipline | string | null;
...
export interface PageBlock {
	...
	item?: BlockHero | BlockRichtext | BlockForm | BlockPost | BlockGallery | BlockEvent | BlockMember | BlockDiscipline | string | null;
...
export interface Post {
	...
	disciplines?: PostsDiscipline[] | string[];
}

export interface PostsDiscipline {
	/** @primaryKey */
	id: number;
...
export interface Schema {
	...
	block_disciplines: BlockDiscipline[];
	...
	disciplines_translations: DisciplinesTranslation[];
	events: Event[];
	events_disciplines: EventsDiscipline[];
	events_files: EventsFile[];
	events_translations: EventsTranslation[];
	form_fields: FormField[];
	form_fields_disciplines: FormFieldsDiscipline[];
	forms: Form[];
	...
	languages: Language[];
	members: Member[];
	members_disciplines: MembersDiscipline[];
	navigation: Navigation[];
	navigation_items: NavigationItem[];
	page_blocks: PageBlock[];
	pages: Page[];
	posts: Post[];
	posts_disciplines: PostsDiscipline[];
...
export enum CollectionNames {
	...
	block_disciplines = 'block_disciplines',
	...
	disciplines_translations = 'disciplines_translations',
	events = 'events',
	events_disciplines = 'events_disciplines',
	events_files = 'events_files',
	events_translations = 'events_translations',
	form_fields = 'form_fields',
	form_fields_disciplines = 'form_fields_disciplines',
	forms = 'forms',
	...
	languages = 'languages',
	members = 'members',
	members_disciplines = 'members_disciplines',
	navigation = 'navigation',
	navigation_items = 'navigation_items',
	page_blocks = 'page_blocks',
	pages = 'pages',
	posts = 'posts',
	posts_disciplines = 'posts_disciplines',
