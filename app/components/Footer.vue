...
const lightLogoUrl = computed(() =>
	props.globals.logo ? `${runtimeConfig.public.directusUrl}/assets/${props.globals.logo_dark_mode}` : '/images/logo.svg',
);
...
<template>
	<footer v-if="globals" ref="footerRef" class="bg-gray py-16">
